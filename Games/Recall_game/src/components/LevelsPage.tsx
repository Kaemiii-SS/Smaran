...
export function LevelsPage({
  ...
  return (
    <div className="relative min-h-screen w-full flex flex-col overflow-hidden bg-background font-sans">
      {/* Background Video */}
      <video
        ref={bgVideoRef}
        autoPlay
            ...
            return (
              <button
                ...
                className={cn(
                  ...
                  isUnlocked 
                    ? "bg-gradient-to-b from-orange-400 to-orange-500 border-orange-300 shadow-[0_6px_0_#c2410c,0_10px_10px_rgba(0,0,0,0.3)] hover:translate-y-[2px] hover:shadow-[0_4px_0_#c2410c,0_8px_8px_rgba(0,0,0,0.3)] active:translate-y-[6px] active:shadow-none"
                    : "bg-gradient-to-b from-orange-500/80 to-orange-600/80 border-orange-400/50 shadow-[0_6px_0_#9a3412,0_10px_10px_rgba(0,0,0,0.2)] opacity-80 cursor-not-allowed grayscale-[0.2]"
                )}
              >
                ...
                <div className="flex-1 flex items-center justify-center pt-1 md:pt-2 w-full">
                  {isUnlocked ? (
                    ...
                    <Lock className="w-8 h-8 md:w-10 md:h-10 text-slate-300 drop-shadow-[0_2px_0_rgba(0,0,0,0.5)] fill-slate-200" strokeWidth={1.5} />
                  )}
                </div>
                    ...
                    <Star
                      ...
                      className={cn(
                        ...
                        isUnlocked && starIdx <= stars
                          ? "fill-yellow-300 text-yellow-600 drop-shadow-[0_1px_0_#b45309]"
                          : "fill-red-900/40 text-red-950/30"
                      )}
