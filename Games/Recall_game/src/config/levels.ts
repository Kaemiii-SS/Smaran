...
export const CATEGORIES: Record<string, string[]> = {
  ANIMALS: [
    '/animals/panda.png', '/animals/bear.png', '/animals/rabbit.png',
    '/animals/cat.png', '/animals/elephant.png', '/animals/monkey.png',
    '/animals/dog.png', '/animals/cow.png',
  ],
  HOUSEHOLD: [
    '/animals/sheep.png', '/animals/fox.png', '/animals/turtle.png',
    '/animals/octopus.png', '/animals/penguin.png', '/animals/horse.png',
    '/animals/pig.png', '/animals/chick.png',
  ],
  FOOD: [
    '/animals/frog.png', '/animals/snake.png', '/animals/dolphin.png',
    '/animals/camel.png', '/animals/zebra.png', '/animals/tiger.png',
    '/animals/deer.png', '/animals/owl.png',
  ],
  NATURE: [
    '/animals/bird.png', '/animals/butterfly.png', '/animals/ladybug.png',
    '/animals/snail.png', '/animals/ant.png', '/animals/crocodile.png',
    '/animals/hippo.png', '/animals/chicken.png',
  ],
};
