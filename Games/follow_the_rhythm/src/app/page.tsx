...
import { useLanguage, TRANSLATIONS, LanguageCode } from '@/lib/LanguageContext';
...
export default function App() {
  const [appState, setAppState] = useState<'entering' | 'landing' | 'loading' | 'game'>('entering');
