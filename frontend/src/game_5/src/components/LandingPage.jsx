...
function LandingPage({
  ...
  return <div className="relative min-h-screen w-full flex flex-col items-center justify-center overflow-hidden bg-background font-sans">
      {
  ...
  />
    ...
    className={`fixed top-5 right-5 z-[9999] flex items-center justify-center w-12 h-12 rounded-full shadow-lg transition-all ${musicEnabled ? "bg-[#16a34a] text-white hover:bg-[#15803d]" : "bg-gray-400 text-white hover:bg-gray-500"}`}
  >
