    ...
    return (
        <div className="relative min-h-screen flex items-center justify-center overflow-hidden bg-[#8cb691]">
            ...
            <div className="absolute inset-0 w-full h-full pointer-events-none z-0">
                ...
                >
                    <defs>
                        <filter id="paper-shadow-login" x="-10%" y="-10%" width="120%" height="120%">
                            <feDropShadow dx="0" dy="12" stdDeviation="15" floodColor="#2a402d" floodOpacity="0.12" />
                        </filter>
                    </defs>
                    
                    <path d="M0,0 V650 C200,600 350,800 550,650 C750,500 800,250 1050,350 C1300,450 1350,700 1440,600 V0 Z" fill="#9bc1a0" filter="url(#paper-shadow-login)" />
                    <path d="M0,0 V450 C150,500 350,300 550,400 C750,500 850,800 1100,650 C1300,530 1350,350 1440,450 V0 Z" fill="#b0cfb4" filter="url(#paper-shadow-login)" />
                    <path d="M0,0 V250 C200,350 400,150 600,250 C800,350 950,600 1200,450 C1350,350 1400,200 1440,300 V0 Z" fill="#cbe5cf" filter="url(#paper-shadow-login)" />
                    <path d="M0,0 V100 C250,170 350,70 650,140 C950,210 1050,400 1250,280 C1400,190 1420,120 1440,170 V0 Z" fill="#e3f2e6" filter="url(#paper-shadow-login)" />
                </svg>
            </div>
                        ...
                        <div className="max-w-sm mx-auto w-full">
                            ...
                            <div className="text-center lg:text-left mb-8">
                                ...
                                <p className="text-sm font-bold text-[#1a2e22]/80" style={{ fontFamily: "'Courier New', Courier, monospace" }}>
                                    Sign in to access your Smaran dashboard.
                                </p>
                            </div>
                            ...
                            <form className="space-y-5" onSubmit={handleSubmit}>
                                ...
                                <button 
                                    type="submit" 
                                    disabled={loading}
                                    className={`group w-full flex items-center justify-center px-8 py-3.5 mt-2 text-sm font-bold text-white transition-all duration-200 bg-[#0f1912] border border-transparent rounded-2xl shadow-xl shadow-[#0f1912]/20 
                            ...
                            <div className="mt-8 text-center">
                                <p className="text-sm font-bold text-[#1a2e22]/80" style={{ fontFamily: "'Courier New', Courier, monospace" }}>
                                    ...
                                    <Link to="/register" className="text-emerald-800 font-extrabold hover:text-emerald-600 transition-colors underline decoration-2 underline-offset-4">
                                        Sign up
                                    </Link>
                                </p>
                            </div>
